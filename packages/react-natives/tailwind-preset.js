...
function loadNativewindPreset() {
  try {
    return require("nativewind/preset");
  } catch {
    // When this package is linked from a local source path, resolve from the app.
    const appRequire = createRequire(path.join(process.cwd(), "package.json"));
    return appRequire("nativewind/preset");
  }
}
