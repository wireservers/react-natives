...
The public docs site does not expose sign-in or account routes. Do not add a login button, account menu, or MSAL provider unless the product requirement explicitly brings authentication back.
