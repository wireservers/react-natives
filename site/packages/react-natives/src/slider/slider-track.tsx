...
import { View, Platform, type LayoutChangeEvent, type GestureResponderEvent } from 'react-native';
...
>(({ className, children, ...props }, ref) => {
  ...
  // On web, the parent Slider handles pointer events; on native, use responder system
  const responderProps = isWeb
    ? {}
    : {
