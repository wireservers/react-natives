...
import { Snackbar, SnackbarText, SnackbarActionButton, Button, ButtonText, Text } from '@wireservers/react-natives';
...
export default function SnackbarExamples() {
  ...
  useExampleCode(`import { Snackbar, SnackbarText, SnackbarActionButton, Button, ButtonText } from '@wireservers/react-natives';
