...
import { BRAND_COLOR, BRAND_COLOR_DARK, BRAND_GRADIENT } from '@/constants/brand';
...
function SunIcon({ color, size = 18 }: { color: string; size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path d="M12 2.5v2.2M12 19.3v2.2M21.5 12h-2.2M4.7 12H2.5M18.7 5.3l-1.6 1.6M6.9 17.1l-1.6 1.6M18.7 18.7l-1.6-1.6M6.9 6.9L5.3 5.3" stroke={color} strokeWidth={1.8} strokeLinecap="round" />
    </Svg>
  );
}
...
function MoonIcon({ color, size = 18 }: { color: string; size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M20.2 14.5a8.5 8.5 0 1 1-10.7-10.7 7 7 0 1 0 10.7 10.7Z" stroke={color} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
...
function PaletteIcon({ color, size = 18 }: { color: string; size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M12 3a9 9 0 1 0 0 18h1.2a2.8 2.8 0 0 0 0-5.6h-1.5a2.2 2.2 0 1 1 0-4.4h2.1A4.2 4.2 0 0 0 18 6.8 3.8 3.8 0 0 0 14.2 3H12Z" stroke={color} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
        ...
        <View style={{ marginLeft: 'auto', flexDirection: 'row', alignItems: 'center', gap: 16 }}>
          ...
          <WithTooltip label="Theme settings">
            ...
            >
              ...
              <Text style={{ color: settingsOpen ? BRAND_COLOR : textColor, fontSize: 13, fontWeight: '600' }}>
                Theme
              </Text>
            </Pressable>
          </WithTooltip>
          ...
          >
            <WithTooltip label="Switch to light mode">
              ...
              >
                <SunIcon color={!isDark ? BRAND_COLOR : textColor} size={16} />
                <Text style={{ color: !isDark ? BRAND_COLOR : textColor, fontSize: 12, fontWeight: '600' }}>
                  Light
                </Text>
              </Pressable>
            </WithTooltip>
            <WithTooltip label="Switch to dark mode">
              ...
              >
                <MoonIcon color={isDark ? BRAND_COLOR : textColor} size={16} />
                <Text style={{ color: isDark ? BRAND_COLOR : textColor, fontSize: 12, fontWeight: '600' }}>
                  Dark
                </Text>
              </Pressable>
