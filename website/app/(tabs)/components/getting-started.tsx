      ...
      >
        ...
        >
          ...
          <View style={{ marginBottom: 32 }}>
            <StepItem
              n={1}
              title="Create a new Expo app"
              c={c}
              isSmall={isSmall}
            />
            <CodeBlock code={`npx create-expo-app@latest my-app\ncd my-app`} />
            <View style={{ height: 16 }} />

            <StepItem
              n={2}
              title="Install React-Natives and peer dependencies"
              c={c}
              isSmall={isSmall}
            />
            <CodeBlock
              code={`npm install @wireservers-ui/react-natives\n\n# Peer dependencies (install those you need)\nnpm install nativewind tailwind-variants\nnpm install react-native-reanimated react-native-gesture-handler react-native-svg`}
            />
            <View style={{ height: 16 }} />
            ...
            >
              In your tailwind.config.js, add the React-Natives preset and
              include the library source in the content array:
            </Text>
            <CodeBlock
            ...
            <StepItem
              n={4}
              title="Set up the theme provider"
              c={c}
              isSmall={isSmall}
            />
            <Text
            ...
            >
              Wrap your app root with the ThemeProvider and define your color
