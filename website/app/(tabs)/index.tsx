...
import { BRAND_COLOR, BRAND_COLOR_DARK, BRAND_COLOR_LIGHT, BRAND_GRADIENT } from '@/constants/brand';
      ...
      >
        <Container maxWidth={1680} style={{
          ...
          <View style={{ flex: isWide ? 1 : undefined }}>
            {/* Badge */}
            <View
              style={{ alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(255,255,255,0.25)', paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20, marginBottom: 24 }}
            >
            ...
            {/* Main heading */}
            <Text
              style={{ fontSize: isXWide ? 80 : isWide ? 52 : isMobile ? 30 : 40, fontWeight: '800', color: '#fff', lineHeight: isXWide ? 92 : isWide ? 60 : isMobile ? 36 : 48, marginBottom: 16 }}
            >
            ...
            {/* Subtitle */}
            <Text
              style={{ fontSize: isXWide ? 22 : isMobile ? 15 : 16, color: 'rgba(255,255,255,0.75)', lineHeight: isXWide ? 34 : 24, marginBottom: 28, maxWidth: 520 }}
            >
            ...
            <View style={{ flexDirection: 'row', gap: 12 }}>
              ...
              >
                <Text style={{ color: BRAND_COLOR_DARK, fontWeight: '600', fontSize: 14 }}>
                  Browse Components
                </Text>
          ...
          {isWide && (
            <View style={{ flex: 1, backgroundColor: '#1F2937', borderRadius: 16, overflow: 'hidden' }}>
              ...
              <Text style={{ fontFamily: 'monospace', fontSize: isXWide ? 16 : 13, color: '#D1D5DB', padding: 24, lineHeight: isXWide ? 26 : 22 }}>{`import {
...
export default function App() {
  return (
    <Card>
      ...
      <Container style={{ paddingHorizontal: isWide ? 48 : 20, paddingTop: 20, paddingBottom: isXWide ? 80 : 40 }}>
      ...
      <View style={{ alignItems: 'center', paddingBottom: 40 }}>
        <Pressable
          onPress={() => router.navigate('/components' as any)}
          style={{ backgroundColor: BRAND_COLOR, paddingHorizontal: 28, paddingVertical: 14, borderRadius: 8, flexDirection: 'row', alignItems: 'center', gap: 8 }}
        >
      ...
      <View style={{ backgroundColor: '#111827' }}>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            <Text
              style={{ fontSize: isXWide ? 52 : 30, fontWeight: '800', color: '#fff', lineHeight: isXWide ? 62 : 36, marginBottom: 14 }}
            >
              Simple. Powerful.{'\n'}Elegant.
            </Text>
            <Text
              style={{ fontSize: isXWide ? 20 : 15, color: 'rgba(255,255,255,0.55)', lineHeight: isXWide ? 32 : 22, marginBottom: 28, maxWidth: isXWide ? '45%' : 380 }}
            >
            ...
            <View style={{ gap: 16 }}>
              <ChecklistItem
                ...
                subtitle="npm install @wireservers-ui/react-natives"
              />
              <ChecklistItem
...
export default function App() {
  return (
    <Card>
      ...
      >
        <Container maxWidth={1680} style={{ paddingVertical: isXWide ? 100 : 56, paddingHorizontal: isWide ? 48 : 24, alignItems: 'center' }}>
          <Text
            style={{ fontSize: isXWide ? 60 : isWide ? 36 : 28, fontWeight: '800', color: '#fff', textAlign: 'center', marginBottom: 10 }}
          >
