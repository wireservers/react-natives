...
import type { SelectVariant } from '@wireservers-ui/react-native-ui';
...
export default function SelectExamples() {
  ...
  return (
    <View className="gap-6">
      <RNText className="text-xl font-bold text-typography-900">Select</RNText>
      <RNText className="text-sm text-typography-500">
        Select provides a dropdown menu for choosing a single value from a list
        of options. It uses a portal for the dropdown content.
      </RNText>
