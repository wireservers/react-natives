...
export default function CalendarExamples() {
  ...
  return (
    <View className="gap-6">
      <RNText className="text-xl font-bold text-typography-900">Calendar</RNText>
      <RNText className="text-sm text-typography-500">
        A compound calendar component with day/week/month time ranges, horizontal timeline and vertical list layouts, team member columns, and color-coded events.
      </RNText>
